...
from handlers import start_command, handle_text, handle_callback_query, list_orders
...
def main():
    ...
    app.add_handler(CommandHandler("orders", list_orders))  # Ensure this line is present
